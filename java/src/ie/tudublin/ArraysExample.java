...
// 	// 	for(int yAxis = 0; yAxis <= 150; yAxis += 10)
// 	// 	{
// 	// 		//When yAxis = 0, return height - border
// 	// 		//When
// 	// 		// Drawing the Y-Axis Marks
// 	// 		float y = map(yAxis, 0, 150, height - border, border);
// 	// 		line(border, yAxis, border - 5, yAxis);
// 	// 		text(yAxis, border / 2, y);
// 	// 	}
...
// 		{
// 			float angles = map(rainFall[index], 0, (2 * PI), 0, (2 * PI));
// 			arc(250, 250, 150, 150, rainFall[index], angles);
// 		}
// 	}
